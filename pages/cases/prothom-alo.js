...
export default function ProthomAlo({ title, description }) {
    return (
        <>
            <Layout
                pageTitle={`${title} | Prothom Alo`}
                description={description}
            >
                <div className="container m-auto px-5 py-10 sm:px-12 md:px-20 max-w-screen-xl">
                    <div className="text-center">
                        <img className="w-64 mx-auto" src="/images/brands/palo.svg" alt="Prothom Alo" />
                        <h2 className="text-5xl font-light mt-5 max-w-4xl mx-auto">Integration backend with react frontend</h2>
                    </div>
                    ...
                    <div>
                        <img src="/images/palo_thumbnail.jpg" className="w-full" />
                    </div>
                </div>
            </Layout>
        </>
