...
export default function CaseList({ title, description }) {
    return (
        <>
            <Layout pageTitle={`${title} | Success Cases`} description={description}>
                <section className="md:container md:mx-auto">
                    <div className="flex-1 justify-center items-center py-20">
                        <h2 className="text-center font-bold uppercase text-2xl lg:text-4xl tracking-wider mb-10">SUCCESS CASES</h2>
                    ...
                    <div className="md:container md:mx-auto transition duration-200 bg-white hover:bg-green-100 py-6 px-6 group">
                        <div className="flex flex-wrap">
                            <div className="w-full md:w-2/3 p-2">
